...
Shader "Custom/SnowCoverNoNormalMap"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            //float3 worldNormal = mul((float4x4)unity_ObjectToWorld, IN.worldNormal);

            float snowFitness = (dot(IN.worldNormal, _SnowDirection) + 1) / 2;           
